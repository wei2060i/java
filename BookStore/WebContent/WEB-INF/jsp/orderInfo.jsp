										...
										<c:forEach items="${order.orderItems }" var="o" varStatus="vs">
											<table width="100%" border="0" cellspacing="0">
												<tr>
													...
													<td width="10%">${o.p.price * o.buynum }</td>
												</tr>
											</table>
											<c:set var="sum" value="${sum+o.p.price * o.buynum }"/>
									   </c:forEach>	
											<table cellspacing="1" class="carttable">
												<tr>
											...
											<p style="text-align:right">
												<a href="${pageContext.request.contextPath }/payOnlineServletDelay?orderid=${order.id }&money=${sum}"><img src="${pageContext.request.contextPath }/images/gif53_029.gif" width="204"
