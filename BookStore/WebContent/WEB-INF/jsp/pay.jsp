...
<body>
	<form action="${pageContext.request.contextPath }/payOnlineServlet" method="post">
		订单号：<INPUT TYPE="text" NAME="orderid" value="${orderid }"> 支付金额：<INPUT
		...
		<div class="divBank">
			...
			<div style="margin-left: 20px;">
				...
				<img name="ICBC-NET-B2C" align="middle" src="${pageContext.request.contextPath }/bank_img/icbc.bmp" /> 
				<input id="CMBCHINA-NET-B2C" type="radio" name="yh" value="CMBCHINA-NET-B2C" />
				<img name="CMBCHINA-NET-B2C" align="middle" src="${pageContext.request.contextPath }/bank_img/cmb.bmp"/> 
				<input id="ABC-NET-B2C" type="radio" name="yh" value="ABC-NET-B2C" /> 
				<img name="ABC-NET-B2C" align="middle" src="${pageContext.request.contextPath }/bank_img/abc.bmp"/> 
				<input id="CCB-NET-B2C" type="radio" name="yh" value="CCB-NET-B2C" />
				<img name="CCB-NET-B2C" align="middle" src="${pageContext.request.contextPath }/bank_img/ccb.bmp" />
				</div>
				<div style="margin-bottom: 20px;">
				<input id="BCCB-NET-B2C" type="radio" name="yh" value="BCCB-NET-B2C" /> 
				<img name="BCCB-NET-B2C" align="middle" src="${pageContext.request.contextPath }/bank_img/bj.bmp" /> 
				<input id="BOCO-NET-B2C" type="radio" name="yh" value="BOCO-NET-B2C" />
				<img name="BOCO-NET-B2C" align="middle" src="${pageContext.request.contextPath }/bank_img/bcc.bmp" />
				<input id="CIB-NET-B2C" type="radio" name="yh" value="CIB-NET-B2C" /> 
				<img name="CIB-NET-B2C" align="middle" src="${pageContext.request.contextPath }/bank_img/cib.bmp" /> 
				<input id="NJCB-NET-B2C" type="radio" name="yh" value="NJCB-NET-B2C" />
				<img name="NJCB-NET-B2C" align="middle" src="${pageContext.request.contextPath }/bank_img/nanjing.bmp" />
				</div>
				<div style="margin-bottom: 20px;">
