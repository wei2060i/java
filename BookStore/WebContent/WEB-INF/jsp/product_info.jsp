			...
			<tr>
				...
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
						<a href="index.html">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;<a
							href="product_list.html">&nbsp;${Bookinfo.category }</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;${Bookinfo.name }
					</div>
									...
									<tr>
										<td width="30%">
											...
											<div style="text-align:center; margin-top:25px">
												<a href="${pageContext.request.contextPath }/addCartServlet?id=${Bookinfo.id}">
										...
										<td style="padding:20px 5px 5px 5px"><img
											...
											class="bookname">&nbsp;&nbsp;${Bookinfo.name }</font>

											<hr />售价：<font color="#FF0000">￥100</font>
											<hr /> 类别：${Bookinfo.category }

											<hr />
											<p>
												<b>内容简介：</b>
											</p>${Bookinfo.description }</td>
									</tr>
								</table></td>
						</tr>
					</table>
