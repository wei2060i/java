		...
		<table width="100%" border="0" cellspacing="0">
			<tr>
				...
				<td><div style="text-align:right; margin:5px 10px 5px 0px">
						<a href="${pageContext.request.contextPath }/jumpSevlet?path=index.jsp">首页</a>&nbsp;&nbsp;&nbsp;&nbsp;&gt;&nbsp;&nbsp;&nbsp;&nbsp;购物车
					</div>
										...
										<td>
											<table cellspacing="1" class="carttable">
												...
												<td width="20%"><input type="button" value='-'
															style="width:20px"
															onclick="changeNum('${entry.value.id}','${entry.value.count-1 }','${entry.value.pnum }')">

															<input name="text" type="text" value="${entry.value.count }"
														...
														<td width="10%">${entry.value.count*entry.value.price }</td>

														<td width="10%"><a href="${pageContext.request.contextPath}/changeNumServlet?id=${entry.value.id}&num=0"
															style="color:#FF0000; font-weight:bold">X</a></td>
													</tr>
													<c:set var="sum" value="${sum+entry.value.count*entry.value.price }"> </c:set>										
											</c:forEach>										
											</table>
											<table cellspacing="1" class="carttable">
												<tr>
											...
											<div style="text-align:right; margin-top:10px">
												...
												&nbsp;&nbsp;&nbsp;&nbsp;<a
													href="${pageContext.request.contextPath}/jumpSevlet?path=order.jsp"><img
