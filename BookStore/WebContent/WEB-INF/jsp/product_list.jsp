					...
					<table cellspacing="0" class="listcontent">
						<tr>
							<td>
								<h1>商品目录</h1>
								<hr />
								<h1>${empty pb.category ?"全部商品":pb.category}</h1>&nbsp;&nbsp;&nbsp;&nbsp;共${pb.count }种商品
								<hr />
										...
										<c:forEach items="${pb.products }" var="b">
											<td>
												<div class="divbookpic">
													<p>
														<a href="#"><img
															src="${pageContext.request.contextPath }/bookcover/${b.img_url}"
															width="115" height="129" border="0" /> </a>
													</p>
												</div>
												<div class="divlisttitle">
													<a
														href="${pageContext.request.contextPath }/findBookInfoServlet?id=${b.id}">书名:${b.name}<br />售价:${b.price } </a>
												</div>
											</td>
										</c:forEach>						
									</tr>
