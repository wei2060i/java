...
public class SendJMail {
		...
		String from = "m18272637169_1@163.com"; 				// 邮件发送人的邮件地址
		String to = email; 										// 邮件接收人的邮件地址
		final String username = "m18272637169_1@163.com";  	//发件人的邮件帐户
		final String password = "yue2060!?";   				//发件人的邮件密码
